    ...
    return (
        <div className="relative pb-16">
            <div>
                ...
                <Image src={currentImage} width={1500} height={900} alt={`Image ${current + 1}`} className="h-[500px] object-cover w-full"/>
                {current === 1 && (
                ...
                {current === 0 && (
                    <div className="absolute top-[20%] left-[5%] bg-white p-6 max-w-[450px]">
                        ...
                        <h4 className="text-[1.2rem]">CoL Business will help you grow. Find out what we can do for yours.</h4>
                    </div>
                )}
